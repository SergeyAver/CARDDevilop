...
public class DataGenerator {
    ...
    public static String generateCity () {
        ...
        final String [] administrativeCenters = new String[] {"Майкоп", "Горно-Алтайск", "Уфа", "Улан-Удэ",
        ...
        return administrativeCenters[random.nextInt(85)];
    }
    ...
    public static class Registration {
        ...
        public static FormInfo generateUser (String locale) {
            return new FormInfo();
        }
    }
}
